...
export const combobox = tv({
  slots: {
    ...
    popup: [
      ...
      "bg-popover text-popover-foreground scroll-py-2 overflow-y-auto overscroll-contain rounded-md px-2 py-2",
    ...
    item: [
      ...
      "text-muted-foreground svg-not-size:size-4 flex cursor-pointer items-center gap-2 rounded-md p-2 outline-none select-none",
    ],
